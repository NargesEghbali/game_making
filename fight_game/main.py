...
back=pygame.transform.scale(pygame.image.load('back2.jpg'),(800,500))
...
def draw_screen(p1_loc,p2_loc,p1_bullets,p2_bullets):
    ...
    pygame.draw.line(screen,'red2',(400,0),(400,500),10)
...
def p2_movement(pressed_keys,p2_loc):
    if pressed_keys[pygame.K_w]and p2_loc.y>0:
        p2_loc.y=p2_loc.y-speed
    if pressed_keys[pygame.K_s] and p2_loc.y<300:
        p2_loc.y=p2_loc.y+speed
    if pressed_keys[pygame.K_d]and p2_loc.x<300:
        p2_loc.x=p2_loc.x+speed
    if pressed_keys[pygame.K_a]and p2_loc.x>0:
        p2_loc.x=p2_loc.x-speed
...
def main():
    ...
    while run:
        ...
        p2_movement(pressed_keys,p2_loc)
